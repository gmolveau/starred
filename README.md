...
- [intel-go/cpuid](https://github.com/intel-go/cpuid) - Intel CPUID library for Go Programming Language
...
- [miguelgrinberg/alchemical](https://github.com/miguelgrinberg/alchemical) - SQLAlchemy 1.4+ wrapper that simplifies its use in Python applications. Can be used with Flask, FastAPI or other web frameworks.
...
- [py2exe/py2exe](https://github.com/py2exe/py2exe) - A distutils extension to create standalone Windows programs from Python code
...
- [philmtd/css-fx-layout](https://github.com/philmtd/css-fx-layout) - A lightweight SCSS/CSS only flexbox library inspired by Angular's flex-layout.
