...
- [GoSH](https://github.com/TheSecondSun/GoSH) - Golang reverse/bind shell generator
...
- [graphql-go-pets-example](https://github.com/deltaskelta/graphql-go-pets-example) - An example of neelance/graphql-go, resolves against sqlite
...
- [Peergos](https://github.com/Peergos/Peergos) - A p2p, secure file storage, social network and application platform
...
- [pervane](https://github.com/hakanu/pervane) - Plain text file based note taking and knowledge base building tool
...
- [ldapper](https://github.com/UMIACS/ldapper) - ldapper -- a simple, ergonomic Python ORM for interacting with LDAP
...
- [sanelogging](https://github.com/sneak/sanelogging) - Sane Defaults for Python Logging
...
- [aquatic](https://github.com/greatest-ape/aquatic) - Blazingly fast, multi-threaded UDP BitTorrent tracker written in Rust
